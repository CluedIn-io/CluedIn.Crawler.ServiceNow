...
{
    public class ServiceNow_Command_MeshProcessor : BaseMeshProcessor
    {
        public ServiceNow_Command_MeshProcessor(ApplicationContext appContext)
            : base(appContext)
        {
        }

        public override Guid GetProviderId() =>
          ServiceNowConstants.ProviderId;
