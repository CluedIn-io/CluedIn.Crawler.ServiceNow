...
{
    public class GetCrawlJobDataBehaviour : ServiceNowProviderTest
    {
        ...
        [Theory]
        [InlineAutoData(ServiceNowConstants.KeyName.Username, nameof(ServiceNowCrawlJobData.Username))]
