...
{
    public class DataIngestion : IClassFixture<ServiceNowTestFixture>
    {
        private readonly ServiceNowTestFixture fixture;
        private readonly ITestOutputHelper output;

        public DataIngestion(ServiceNowTestFixture fixture, ITestOutputHelper output)
        {
